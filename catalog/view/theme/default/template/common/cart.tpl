<div id="cart" class="btn-group btn-block">
  <button type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="az-btn"><!-- <i class="fa fa-shopping-cart"></i> <--><img src="image/az-cart.png" alt=""></--> <span id="cart-total"><?php echo $text_items; ?></span></button>
